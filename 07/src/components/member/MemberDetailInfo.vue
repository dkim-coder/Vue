...
// TODO:08-1. 프로그래밍적인 경로 이동을 위해 useRouter를 추가하세요.
...
const updateMember = () => {
  // TODO: 08-2. 회원 수정 관련 경로(auth/member-modify-form/admin@ssafy.com)를 route를 추가하고 이동 처리하세요.
...
const deleteMember = () => {
  if (confirm('정말 삭제하시겠습니까?')) {
    // TODO: 08-3. 회원 삭제 시 목록으로 이동 처리하세요.
     console.log('목록으로 이동')
