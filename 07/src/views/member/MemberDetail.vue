...
// TODO: 07-1. router를 통해서 전달된 파라미터(email)를 확인하세요.

// END

// TODO: 07-2. 어떤 회원의 정보를 보고 있다가 로그인 사용자의 정보를 보는 과정을 감지해보자.
//  http://localhost:5173/auth/member-detail/email_0.ssafy.com -->http://localhost:5173/auth/member-detail/admin@ssafy.com
